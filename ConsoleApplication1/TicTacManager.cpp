...
void TicTacManager::MakeMove(bool& closed)//вызов отрисвоки доски и проверка на ебланский ход проверка на завершение игры + смена игрока 1 на 2 или 2 на 1
{
	Texture TextureBoard2;
	Sprite Board2;
	TextureBoard2.loadFromFile("images/Board-background.jpg");
	Board2.setTexture(TextureBoard2);
	//Board2.setTextureRect(IntRect(0, 0, 649, 51));
